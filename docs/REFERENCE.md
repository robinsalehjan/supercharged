...
- AI and agent tools: `codex`, `ollama`, `omlx`, `replicate`, `rtk`, `worktrunk`, OpenWiki, Playwright CLI, Playwright MCP, and Obscura. ChatGPT and CodexBar are included when `INSTALL_CODEX_APP=Y`.
