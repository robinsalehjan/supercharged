...
echo "   1. Review claude_config/installed_plugins.json for backed-up plugins"
echo "   2. Install/enable plugins via /plugin command in Claude Code"
echo "   3. Enable work plugins (@vend-plugins) manually if on work machine"
echo "   4. Run /reload-plugins to force registry rescan"
echo "   5. Verify with /help that skills and agents are available"
echo ""
