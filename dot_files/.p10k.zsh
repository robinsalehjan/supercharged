# Generated by Powerlevel10k configuration wizard on 2024-03-20 at 13:03 CET.
...
() {
  ...
  # - local   `asdf current` says "set by /some/project/dir/.tool-versions"
  # - global  `asdf current` says "set by $HOME/.tool-versions"
  #
